...
contract DeployPool is Script {
    ...
    function run() public {
        ...
        uint256 token0Amount = WETH_ADDRESS == TOKEN0_ADDRESS ? 5e18 : 2000e6;
        uint256 token1Amount = WETH_ADDRESS == TOKEN1_ADDRESS ? 5e18 : 2000e6;
        ...
        console.log("Token0 balance %s", token0Balance);
        console.log("Token1 balance %s", token1Balance);
        console.log("Deploying new Panoptic pool... Token0=%s, token1=%s", TOKEN0_ADDRESS, TOKEN1_ADDRESS);
